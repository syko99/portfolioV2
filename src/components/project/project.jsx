...
const Project = ({ project }) => {
    let projectSkills = project.skills.map((icon) => {
        return <ProjectSkill icon={icon} />
    })
    ...
    return (
        <div
            ...
            <div className='flex flex-col'>
                ...
                <div className='flex items-center gap-1'>{projectSkills}</div>
            </div>
            <div className='w-100 mt-8'>
                <img
                    src={project.image}
                    alt={project.imageAlt}
                    rel={project.imageRel}
                    width={600}
                    height={400}
                    className='mx-auto'
                />
