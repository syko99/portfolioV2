            ...
            <div className="flex flex-col gap-4">
                ...
                <div className='flex gap-4 justify-center items-center'>
                    <a href={project.live} target='_' className='w-full max-w-xs'>
                        <button className='w-full p-1 border-2 rounded-lg hover:border-slate-300'>Live</button>
                    </a>
                    <a href={project.code} target='_' className='w-full max-w-xs'>
                        <button className='w-full p-1 border-2 rounded-lg hover:border-slate-300'>Code</button>
                    </a>
                </div>
            </div>
        </div>
