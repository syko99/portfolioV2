...
const Skills = () => {
    ...
    return (
        <div className='grid-in-skills w-full bg-white rounded-3xl p-4 relative shadow-lg overflow-hidden dark:shadow-[inset_0_0_2rem_0] dark:shadow-zinc-800 dark:bg-zinc-900 dark:hover-glow-pixel'>
